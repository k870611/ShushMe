...
public class PlaceListAdapter extends RecyclerView.Adapter<PlaceListAdapter.PlaceViewHolder> {
    ...
    public PlaceListAdapter(Context context, PlaceBuffer places) {
        ...
        // TODO (17) Take a PlaceBuffer as an input and store it as a local private member mPlaces
        this.mPlaces = places;
    }
    ...
    public void onBindViewHolder(PlaceViewHolder holder, int position) {
        // TODO (19) Implement onBindViewHolder to set the view holder's Name and Address text fields
    ...
    //TODO (20) Implement a public method swapPlaces that replaces the current mPlaces PlaceBuffer with a new one
    ...
    public int getItemCount() {
        // TODO (18) Update getItemCount to return mPlaces's item count
